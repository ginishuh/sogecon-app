...
- chore(web,api,docs): 1차 안정화 - 서비스 계층 정리 및 버전 문서 정합화 — refs #108, PR #109
...
- chore(ci): gitleaks 오탐 허용 목록 추가 (.gitleaks.toml) — refs #108, PR #111
...
- feat(web): 데스크톱 헤더 네비게이션 추가 — PR #76
  ...
  - chore: OpenAPI 스키마 재생성
  - style: 헤더 메뉴 폰트 KoPub 돋움 볼드, 사이즈 증가, 우측 정렬
