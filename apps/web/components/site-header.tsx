    ...
    <header className="border-b-2 border-[#b60007] bg-white">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 md:px-6">
        <Link href="/" className="flex min-w-0 items-center gap-2 text-brand-primary" aria-label="홈으로">
          <Image src="/images/brand/sogang-signature.png" alt="서강대학교" width={150} height={50} className="h-auto w-[100px] md:w-[150px]" priority />
          <span className="font-kopub text-lg tracking-tight text-neutral-ink md:text-xl truncate">
            경제대학원 총동문회
          </span>
        </Link>
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-md border border-[#e8c0c0] px-3 py-2 text-sm transition hover:bg-[#fff5f5] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#b60007]"
