  ...
  return (
    <header className="border-b-2 border-brand-700 bg-white">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 md:px-6">
        ...
        <button
          type="button"
          className="lg:hidden inline-flex items-center justify-center rounded-md border border-brand-200 px-3 py-2 text-sm text-brand-700 transition hover:bg-brand-50 hover:text-brand-800 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-700"
