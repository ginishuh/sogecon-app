...
export const metadata: Metadata = {
  title: '자주 묻는 질문',
  description:
    '총동문회 웹 런치와 함께 변경되는 로그인 방식, 디렉터리 열람 기준, 개인정보 처리 절차를 정리했습니다. 추가 문의는 사무국으로 연락해 주세요.'
};
...
const faqSections: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <>
            아니요. 디렉터리와 회원 프로필은 활성화된 총동문회 회원만 열람할 수 있습니다. 로그인하지 않은 사용자는 기본 안내 페이지만 볼 수 있으며,
