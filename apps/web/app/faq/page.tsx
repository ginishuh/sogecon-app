...
export const metadata: Metadata = {
  title: '자주 묻는 질문',
  description:
    '총동문회 웹 런치와 함께 변경되는 로그인 방식, 수첩 열람 기준, 개인정보 처리 절차를 정리했습니다. 추가 문의는 사무국으로 연락해 주세요.'
};
...
const faqSections: FAQSection[] = [
  {
    ...
    items: [
      ...
      {
        question: '동문이 아니라도 수첩을 볼 수 있나요?',
        answer: (
          <>
            아니요. 수첩과 회원 프로필은 활성화된 총동문회 회원만 열람할 수 있습니다. 로그인하지 않은 사용자는 기본 안내 페이지만 볼 수 있으며,
  ...
  },
  {
    id: 'features',
    title: '서비스 기능',
    description: '홈 화면, 공지, 행사, 수첩에서 자주 묻는 질문을 모았습니다.',
    items: [
      {
        question: '홈 화면에서 어떤 정보를 빠르게 확인할 수 있나요?',
        answer: (
          <>
            히어로 영역에서 다음 행사를 확인하고, 공지·FAQ·수첩 바로가기 카드를 통해 주요 기능으로 이동할 수 있습니다.
            모바일에서도 동일한 레이아웃을 제공하며, 즐겨찾기 버튼을 이용하면 홈 화면에 바로가기 아이콘을 추가할 수 있습니다.
          </>
        )
      },
      {
        question: '수첩 검색은 어떤 방식으로 작동하나요?',
        answer: (
          <>
