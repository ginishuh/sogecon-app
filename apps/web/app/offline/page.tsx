...
export default function OfflinePage() {
  return (
    <section className="mx-auto flex max-w-2xl flex-col gap-6 px-6 py-16 text-slate-800" aria-labelledby="offline-heading">
      ...
      <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 p-6 text-left">
        <h3 className="mb-3 text-lg font-semibold text-slate-700">다음 단계를 시도해 보세요</h3>
      ...
      <p className="text-xs text-slate-500">
        이 페이지는 홈과 디렉터리 화면의 최소 오프라인 스켈레톤으로 제공되며, 연결이 복구되면 자동으로 최신 데이터로 갱신됩니다.
      </p>
    </section>
  );
}
