...
const sections: PolicySection[] = [
  {
    ...
    content: (
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>서비스 이용 기록(로그인 일시, 접속 IP, 기기 정보), 문의 및 상담 기록, 새 소식 알림 연결 정보</li>
      </ul>
    )
  },
  {
    ...
    content: (
      <ol className="list-decimal space-y-2 pl-5">
        <li>회원 식별 및 로그인, 첫 로그인 설정·비밀번호 재설정 등 서비스 기본 기능 제공</li>
  ...
  },
  {
    id: 'third-party',
    title: '4. 제3자 제공 및 위탁',
    summary: '동문 수첩 공개는 로그인한 동문에 대한 제3자 제공이며, 별도 동의 후에만 이뤄집니다.',
    content: (
      <>
        <p>
          동문 수첩에 이름·기수 외 연락처와 소속 정보를 보여주는 것은 개인정보 보호법상 제3자 제공입니다.
          제공받는 사람은 로그인한 동문이며, 같은 기수만 선택한 경우에는 해당 기수 동문에게만 보입니다.
        </p>
        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>제공 목적: 동문 친목과 연락</li>
          <li>제공 항목: 이름, 기수, 전공, 직장, 부서, 직책, 업종, 휴대전화, 이메일, 주소(개인·직장) 등 회원이 입력하고 공개를 선택한 정보</li>
          <li>보유 기간: 공개를 철회하거나 탈퇴할 때까지. 개별 열람 허용은 허용 취소 또는 탈퇴 시까지입니다.</li>
          <li>거부권: 공개를 거부하거나 나중에 철회해도 가입·로그인은 이용할 수 있으며, 동문 수첩 상세만 잠깁니다. 나중에 다시 공개하려면 동의를 다시 받습니다.</li>
          <li>개별 허용: 나만 보기여도 특정 동문의 보기 요청을 허용하면 그 사람에게만 상세를 제공합니다. 허용은 마이페이지의 동문 수첩 보기 요청에서 언제든 취소할 수 있습니다.</li>
        </ul>
        <p className="mt-3">
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>운영자 계정은 추가 본인 확인을 적용하고, 담당 업무별로 접근 권한을 제한합니다.</li>
