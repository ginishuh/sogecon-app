...
const commitments = [
  {
    title: '디지털 허브 완성',
    body: '2025년 하반기 웹 런치를 통해 언제 어디서든 행사·공지·디렉터리를 확인할 수 있는 원스톱 허브를 완성하겠습니다.'
  },
  {
    title: '투명한 재정과 보고',
...
export default function GreetingPage() {
  return (
    <div className="about-page">
      <AboutHero
        title="회장 인사말"
        description="총원우회 16대 회장 김서강입니다. 2025년 웹 서비스 런치와 함께, 동문 누구나 쉽게 소식을 접하고 의견을 나눌 수 있는 열린 커뮤니티를 만들겠습니다."
      ...
      <section aria-labelledby="greeting-vision-title" className="about-section">
        <div className="about-section__content">
          ...
          <p>
            지난 30년 동안 총원우회는 서로의 지식과 경험을 나누며 성장해 왔습니다. 이제는 모바일과 웹 어디서나
