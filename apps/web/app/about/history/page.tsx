...
const milestones = [
  {
    year: '1994',
    title: '총원우회 창립',
    body: '초기 4개 기수가 연합하여 총원우회를 창립하고, 서강대학교 경제대학원 동문 네트워크의 초석을 다졌습니다.'
  },
  {
    year: '2005',
    title: '장학기금 조성',
    body: '동문 기부로 장학기금을 조성해 재학 중인 후배를 지원하기 시작했습니다. 현재는 연 10명 내외에게 장학금을 지급합니다.'
  },
  {
    year: '2016',
    title: '디지털 커뮤니티 전환',
    body: '회원 포털과 모바일 알림 시스템을 구축하여 행사 신청, 회비 납부, 커뮤니티 운영을 온라인으로 전환했습니다.'
  },
  {
    year: '2024',
    title: 'ESG 프로젝트 론칭',
    body: '지역사회 연계 사회공헌 활동을 본격화하고, ESG 위원회를 신설했습니다.'
  }
];

const pastPresidents = [
  { term: '13대', name: '박지원', period: '2018 - 2019', focus: '디지털 전환, 회원 데이터베이스 정비' },
  { term: '14대', name: '이상훈', period: '2020 - 2021', focus: '코로나 대응 온라인 프로그램 확대' },
...
export default function HistoryPage() {
  return (
    <div className="about-page">
      <AboutHero
        title="역대 회장단과 연혁"
        description="총원우회는 1994년 창립 이후 30년 동안 동문 교류와 사회 공헌을 이어왔습니다. 연혁과 역대 회장단의 주요 활동을 한눈에 정리했습니다."
      ...
      <section aria-labelledby="history-timeline" className="about-section about-section--timeline">
        <div className="about-section__content">
          ...
          <p>
            동문회의 발자취를 간략히 정리했습니다. 더 자세한 기록은 연간 사업 보고서와 자료실을 통해 열람할 수
            있습니다.
          </p>
        </div>
      ...
      <section aria-labelledby="history-archive" className="about-section">
        <div className="about-section__content">
          ...
          <p>
            연간 사업 보고서, 회계 감사 보고, 총회 의사록 등은 로그인한 회원에게 순차적으로 열람 권한을 제공할
            예정입니다. 정식 오픈 전까지는 주요 항목만 요약으로 제공합니다.
          </p>
          <p>
            의견이나 추가 요청이 있다면 사무국으로 알려 주세요. 자료 공개 범위와 형식을 함께 논의하겠습니다.
          </p>
        </div>
