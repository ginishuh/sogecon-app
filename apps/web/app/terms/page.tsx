...
export const metadata: Metadata = {
  title: '이용약관',
  description:
    '서강대 경제대학원 총동문회 웹 서비스 이용과 관련된 회원의 권리, 의무 및 책임사항을 규정합니다. 서비스를 이용하기 전에 약관을 확인해 주세요.'
};
...
const sections: TermsSection[] = [
  {
    ...
    clauses: (
      <p>
        본 약관은 서강대학교 경제대학원 총동문회(이하 &quot;총동문회&quot;)가 제공하는 웹 서비스(이하 &quot;서비스&quot;)의 이용과 관련하여 총동문회와 회원 간의 권리, 의무 및
  ...
  },
  {
    ...
    clauses: (
      <ul className="list-disc space-y-2 pl-5">
        <li>&quot;회원&quot;이라 함은 본 약관에 동의하고 서비스를 이용하는 서강대 경제대학원 총동문회 구성원을 말합니다.</li>
        <li>
          &quot;ID&quot;는 회원 식별과 서비스 이용을 위해 회원이 부여받은 학번을 의미합니다.
        </li>
        <li>&quot;비밀번호&quot;는 회원의 개인정보 보호와 인증을 위하여 회원 본인이 설정한 문자와 숫자의 조합을 말합니다.</li>
        <li>&quot;콘텐츠&quot;는 총동문회가 서비스 상에 게시하거나 회원이 업로드하는 모든 자료를 의미합니다.</li>
      </ul>
    )
  },
  {
    ...
    clauses: (
      <ol className="list-decimal space-y-2 pl-5">
        <li>회원 가입은 총동문회 정회원으로 등록된 경우에 한하여 사용할 수 있습니다.</li>
  ...
  },
  {
    ...
    clauses: (
      <ol className="list-decimal space-y-2 pl-5">
        <li>회원은 본 약관과 관련 법령, 총동문회가 정한 서비스 이용 안내를 준수해야 합니다.</li>
  ...
  },
  {
    ...
    clauses: (
      <>
        ...
        <p className="mt-3">
          총동문회는 필요한 경우 서비스의 내용을 변경하거나 중단할 수 있으며, 변경 사항은 사전에 회원에게 공지합니다.
        </p>
      </>
    )
  },
  {
    ...
    clauses: (
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>천재지변, 정전, 통신 장애 등 불가항력적 사유로 인한 서비스 중단 시 총동문회는 지체 없이 회원에게 공지합니다.</li>
      </ul>
    )
  },
  {
    ...
    clauses: (
      <ol className="list-decimal space-y-2 pl-5">
        <li>서비스와 관련된 저작권 및 지식재산권은 총동문회에 귀속합니다.</li>
        <li>
          회원이 서비스 내에 게시한 콘텐츠의 저작권은 회원에게 있으며, 총동문회는 서비스 운영을 위해 비독점적으로 이를 이용할 수 있습니다.
        </li>
        <li>회원은 서비스 이용으로 얻은 정보를 총동문회의 사전 승인 없이 복제, 전송, 배포, 출판, 방송 등 기타 방법으로 이용하거나 제3자에게 제공할 수 없습니다.</li>
      </ol>
    )
  },
  {
    ...
    clauses: (
      <ol className="list-decimal space-y-2 pl-5">
        <li>회원은 언제든지 마이페이지에서 회원 탈퇴를 신청할 수 있으며, 총동문회는 관련 법령이 정한 범위 내에서 개인정보를 보유/파기합니다.</li>
        <li>회원이 약관을 위반하거나 아래 행위를 하는 경우 총동문회는 사전 통지 후 서비스 이용을 제한하거나 해지할 수 있습니다.
  ...
  },
  {
    ...
    clauses: (
      <ul className="list-disc space-y-2 pl-5">
        <li>총동문회는 천재지변, 전쟁, 기간통신사업자의 서비스 중단 등 불가항력으로 인한 손해에 대해서는 책임을 부담하지 않습니다.</li>
        <li>회원의 귀책사유로 인한 서비스 이용 장애에 대해서는 총동문회가 책임을 지지 않습니다.</li>
        <li>회원이 서비스 내에서 제공한 정보 및 자료의 정확성에 대해 총동문회는 보증하지 않습니다.</li>
      </ul>
    )
  },
  {
  ...
  },
  {
    ...
    clauses: (
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>총동문회는 필요 시 약관을 개정할 수 있으며, 개정 시 최소 7일 전에 공지합니다.</li>
      </ul>
    )
  }
];
    ...
    <div className="space-y-12 rounded-3xl bg-white px-6 py-12 shadow-soft md:px-12">
      <header className="space-y-3">
        ...
        <p className="text-sm leading-6 text-neutral-muted">
          서비스 이용 전에 아래 약관을 확인해 주세요. 총동문회는 회원에게 공정하고 안전한 서비스를 제공하기 위해 약관을 투명하게 운영합니다.
        </p>
      </header>
